...
class Server(Base):
    ...
    # Gateway-Routing: Server ist ueber das Gateway per Hostname-Alias erreichbar
    # (transparente Weiterleitung, jeder Typ/jede Version, Direktverbindung bleibt).
    # Genau ein Server darf Default/Lobby (Apex-Route) sein.
