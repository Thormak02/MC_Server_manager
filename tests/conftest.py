...
def client(tmp_path, monkeypatch):
    ...
    # process_service haelt SessionLocal/engine als Modul-Referenz (u.a. fuer
    # den Autostart-Daemon-Thread). Ohne Reload zeigt diese Referenz auf die
    # DB des ersten Tests -> spaetere Tests laufen gegen ein veraltetes Schema
    # ("no such column"). Reload bindet sie an die frische Test-DB.
